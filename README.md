...
* OpenDSA Domain certificate generated by [Let's Encrypt](https://letsencrypt.org/) certificate authority.
...
* Fill in the template parameters
    ...
    - *AdditionalDomainName*: The same as the DomainName, you may need to change this parameter in case you hit let's encrypt certificates identical limit. Please see About [Let's encrypt](#about-let-s-encrypt) for more details.
